...
export function validateUnits(
  ...
  opts: { maxTouches?: number; maxBodyLines?: number; maxDoSteps?: number; requireCommand?: boolean; exists?: (path: string) => boolean; doneIds?: string[]; knownUnitIds?: string[]; requireServes?: boolean } = {},
): UnitProblem[] {
